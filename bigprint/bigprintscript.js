const translations = {
    ru: {
        brandTitle: "ТАН•ДЕМ",
        sendingTitle: "Большая печать", // Изменено на "Калькулятор цен меню"
        widthLabel: "Ширина (м):",
        ...
        widthPlaceholder: "Введите ширину (м)",
        heightPlaceholder: "Введите высоту (м)"
    },
    am: {
        brandTitle: "ՏԱՆ•ԴԵՄ",
        ...
        widthPlaceholder: "Մուտքագրեք լայնությունը (մ)",
        heightPlaceholder: "Մուտքագրեք բարձրությունը (մ)"
    },
    en: {
        brandTitle: "TAN•DEM",
        ...
        widthPlaceholder: "Enter width (m)",
        heightPlaceholder: "Enter height (m)"
    }
};
